 ...
 *       i jegoż funkcję `parse_line', która próbuje wczytać słowa z linii jako
 *       `ParsedLine'y' i dodać je do wspomnianej tablicy `ParsedText'
 ...
 *       nich samych, aby podobne miały takie same tablicowe reprezentacje
 ...
 *       zdobywamy poszukiwane tablice podobnych wierszy
